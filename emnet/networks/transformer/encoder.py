...
import torch
from nd_rotary_encodings import prep_multilevel_positions
...
from pytorch_sparse_utils.utils import BatchTopK, batch_topk
...
from ...config.transformer import RoPEConfig, TransformerEncoderConfig
from ...networks.transformer.blocks import (
    FFNBlock,
    SelfAttentionBlock,
)
from ...networks.transformer.blocks.background_transformer import (
