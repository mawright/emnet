...
from emsim.utils.sparse_utils.ops.subset_attn.autograd_helpers import split_heads
...
class TestSplitHeads:
    ...
    def test_split_heads_indivisible(self):
        ...
        with pytest.raises(
            (ValueError, torch.jit.Error), match="Last dimension of tensor"
        ):
    ...
    def test_split_heads_invalid_dim(self):
        ...
        with pytest.raises(
            (ValueError, torch.jit.Error), match="Expected tensor to be 2D or 3D"
        ):
